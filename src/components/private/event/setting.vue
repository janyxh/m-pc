  ...
  <div class="mask-setting">
    <div class="preview">
      <div class="phone">
        ...
        <iframe
          ...
          height="560"
          frameborder="0"
          src="https://v6.rabbitpre.com/m2/aUe1ZjFIem"
        ></iframe>
        <!-- 朋友圈 -->
    ...
    <div class="window">
      <el-form :model="settingForm" :rules="rules" ref="settingForm" label-width="100px">
        ...
        <el-checkbox-group
          v-model="settingForm.setWeChatView"
          @change="handleChangeSetWechat"
          class="chx-set-wechat"
        >
        ...
        <div v-if="settingForm.setWeChatView" class="bg-set-wechat">
          <el-form-item label="标题" prop="weChatTitle" ref="weChatTitle">
            ...
            <el-input
              placeholder="请输入内容"
              v-model="settingForm.weChatTitle"
              :disabled="settingForm.weChatTitleType === 0"
            >
              <el-select
                v-model="settingForm.weChatTitleType"
                slot="prepend"
                placeholder="请选择"
                @change="changeTitle(settingForm.weChatTitleType)"
              >
          ...
          <el-form-item label="摘要" prop="weChatDescribe" ref="weChatDescribe">
            ...
            <el-input
              placeholder="请输入内容"
              v-model="settingForm.weChatDescribe"
              :disabled="settingForm.weChatDescribeType === 0"
            >
              <el-select
                v-model="settingForm.weChatDescribeType"
                slot="prepend"
                placeholder="请选择"
                @change="changeDescribe(settingForm.weChatDescribeType)"
              >
      ...
      <div class="footer-setting">
        ...
        <p class="isSwitch">
          <el-tooltip :content="getStatus(settingForm.status)" placement="top">
            <i
              v-if="settingForm.status === 0"
              class="iconfont icon-switch-close"
              @click="handleDraft"
            ></i>
            <i
              v-else-if="settingForm.status === 1"
              class="iconfont icon-switch-open"
              @click="handleReleased"
            ></i>
            <i
              v-else-if="settingForm.status === 2"
              class="iconfont icon-switch-open icon-switch-relation"
            ></i>
          </el-tooltip>
        </p>
